...
## Known gemma3:4b Limitations

- **Non-JSON output**: gemma3:4b often prefixes JSON with prose or markdown fences.
...
- **ScenarioPlan complexity**: The planner prompt is deliberately detailed to force
  correct structure, but gemma3:4b may produce fewer scenarios than requested.
